...
*/
   ...
   /**Returns the smallest icosahedron in the list.
   *@return Icosahedron
   */
   public Icosahedron findIcosahedronWithShortestEdge() {
      if (icosahedronList.length == 0) {
         return null;
      }
      double smallestOne = icosahedronList[0].getEdge();
      int n = 0;
      for (int i = 0; i < icosahedronList.length; i++) {
         if (icosahedronList[i] != null) {
            if (icosahedronList[i].getEdge() < smallestOne)
            { 
               smallestOne = icosahedronList[i].getEdge();
               n = i;   
            }
         }
      }
      return icosahedronList[n];
   }
   /**Returns the biggest icosahedron in the list.
   *@return Icosahedron
   */
   public Icosahedron findIcosahedronWithLongestEdge() {
      ...
      double biggestOne = icosahedronList[0].getEdge();
      int n = 0;
      for (int i = 0; i < icosahedronList.length; i++) {
         if (icosahedronList[i] != null) {
            if (icosahedronList[i].getEdge() > biggestOne)
            { 
               biggestOne = icosahedronList[i].getEdge();
               n = i;   
            }
         }
      }
   ...
   /**Returns the smallest icosahedron in the list by volume.
   *@return Icosahedron
   */
   public Icosahedron findIcosahedronWithSmallestVolume() {
      ...
      double smallestVolume = icosahedronList[0].volume();
      int n = 0;
      for (int i = 0; i < icosahedronList.length; i++) {
         if (icosahedronList[i] != null) {
            if (icosahedronList[i].volume() < smallestVolume)
            { 
               smallestVolume = icosahedronList[i].volume();
               n = i;   
            }
         }
      }
   ...
   /**Returns the biggest icosahedron in the list by volume.
   *@return Icosahedron
   *
   */
   public Icosahedron findIcosahedronWithLargestVolume() {
      ...
      double biggestVolume = icosahedronList[0].volume();
      int n = 0;
      for (int i = 0; i < icosahedronList.length; i++) {
         if (icosahedronList[i] != null) {
            if (icosahedronList[i].volume() > biggestVolume)
            { 
               biggestVolume = icosahedronList[i].volume();
               n = i;   
            }
         }
      }
