...
*  for all tests). **/
   ...
   */
   ...
   /**Tests invalid records report method.
   *@throws FileNotFoundException if not found.
   *@throws InvalidCategoryException if invalid.
   *
   */
   @Test public void generateInvalidRecordsReportTest() 
      throws FileNotFoundException, InvalidCategoryException {
      CardholderProcessor chp = new CardholderProcessor();
      chp.readCardholderFile("cardholder_data_3_exceptions.txt");
      String actual = chp.generateInvalidRecordsReport();
      String expected = "";
      for (String str: chp.getInvalidRecordsArray()) {
         expected += "\n";
         expected += str;
         expected += "\n";
      }
